...
# classroom_lesson_invitations GET    /classrooms/:classroom_id/lessons/:lesson_id/invitations(.:format)                       invitations#index
#                              POST   /classrooms/:classroom_id/lessons/:lesson_id/invitations(.:format)                       invitations#create
#  classroom_lesson_invitation GET    /classrooms/:classroom_id/lessons/:lesson_id/invitations/:id(.:format)                   invitations#show
#                              PATCH  /classrooms/:classroom_id/lessons/:lesson_id/invitations/:id(.:format)                   invitations#update
#                              PUT    /classrooms/:classroom_id/lessons/:lesson_id/invitations/:id(.:format)                   invitations#update
#                              DELETE /classrooms/:classroom_id/lessons/:lesson_id/invitations/:id(.:format)                   invitations#destroy
